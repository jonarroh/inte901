...
export const hlmMenuItemVariants = cva(
	'group w-full relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-navhover hover:text-navhover-foreground focus-visible:bg-navhover focus-visible:text-navhover-foreground disabled:pointer-events-none disabled:opacity-50',
	{
